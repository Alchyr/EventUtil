...
import eventUtil.util.Condition;
...
public class EventUtils {
    ...
    public static <T extends AbstractEvent> void registerEvent(String ID, Class<T> eventClass, Class playerClass) {
        registerEvent(ID, eventClass, playerClass, null, null, null, null, EventType.NORMAL);
    }

    public static <T extends AbstractEvent> void registerEvent(String ID, Class<T> eventClass, String[] actIDs) {
        registerEvent(ID, eventClass, null, actIDs, null, null, null, EventType.NORMAL);
    }

    public static <T extends AbstractEvent> void registerEvent(String ID, Class<T> eventClass, Condition spawnCondition) {
        registerEvent(ID, eventClass, null, null, spawnCondition, null, null, EventType.NORMAL);
    }

    public static <T extends AbstractEvent> void registerEvent(String ID, Class<T> eventClass, Condition spawnCondition, String overrideEvent) {
        registerEvent(ID, eventClass, null, null, spawnCondition, overrideEvent, null, EventType.NORMAL);
    }

    public static <T extends AbstractEvent> void registerEvent(String ID, Class<T> eventClass, Class playerClass, String[] actIDs) {
        registerEvent(ID, eventClass, playerClass, actIDs, null, null, null, EventType.NORMAL);
    }

    public static <T extends AbstractEvent> void registerEvent(String ID, Class<T> eventClass, Class playerClass, String actID) {
        registerEvent(ID, eventClass, playerClass, new String[]{actID}, null, null, null, EventType.NORMAL);
    }

    public static <T extends AbstractEvent> void registerEvent(String ID, Class<T> eventClass, Condition spawnCondition, String[] actIDs) {
        registerEvent(ID, eventClass, null, actIDs, spawnCondition, null, null, EventType.NORMAL);
    }
    ...
    public static <T extends AbstractEvent> void registerEvent(String ID, Class<T> eventClass, String[] actIDs, Predicate<AbstractPlayer> bonusCondition) {
        registerEvent(ID, eventClass, null, actIDs, null, null, bonusCondition, EventType.NORMAL);
    }
    ...
    public static <T extends AbstractEvent> void registerEvent(String ID, Class<T> eventClass, Class playerClass, String[] actIDs, Predicate<AbstractPlayer> bonusCondition) {
        registerEvent(ID, eventClass, playerClass, actIDs, null, null, bonusCondition, EventType.NORMAL);
    }
    ...
    public static <T extends AbstractEvent> void registerEvent(String ID, Class<T> eventClass, Class playerClass, String overrideEvent, boolean fullReplace) {
        registerEvent(ID, eventClass, playerClass, null, null, overrideEvent, null, fullReplace ? EventType.FULL_REPLACE : (overrideEvent == null ? EventType.NORMAL : EventType.OVERRIDE));
    }
    ...
    public static <T extends AbstractEvent> void registerEvent(String ID, Class<T> eventClass, Class playerClass, String overrideEvent, Predicate<AbstractPlayer> bonusCondition, EventType type) {
        registerEvent(ID, eventClass, playerClass, null, null, overrideEvent, bonusCondition, type);
    }
    ...
    public static <T extends AbstractEvent> void registerEvent(String ID, Class<T> eventClass, Class playerClass, String overrideEvent, EventType type) {
        registerEvent(ID, eventClass, playerClass, null, null, overrideEvent, null, type);
    }

    public static <T extends AbstractEvent> void registerEvent(String ID, Class<T> eventClass, Condition spawnCondition, String overrideEvent, EventType type) {
        registerEvent(ID, eventClass, null, null, spawnCondition, overrideEvent, null, type);
    }

    public static <T extends AbstractEvent> void registerEvent(String ID, Class<T> eventClass, Class playerClass, String[] actIDs, Condition spawnCondition, String overrideEvent, Predicate<AbstractPlayer> bonusCondition, EventType type) {
